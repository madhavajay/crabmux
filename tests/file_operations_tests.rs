...
fn test_alias_file_operations() {
    ...
    cmd.arg("alias")
        ...
        .stdout(predicate::str::contains(
            "Created alias 'test-alias' for session 'test-session'",
        ));
...
fn test_alias_query_nonexistent() {
    ...
    cmd.arg("alias")
        ...
        .success()
        .stdout(predicate::str::contains(
            "Alias 'nonexistent-alias' not found",
        ));
}
...
fn test_malformed_alias_file() {
    ...
    cmd.arg("alias")
        ...
        .failure()
        .stderr(
            predicate::str::contains("key must be a string").or(predicate::str::contains("Failed")),
        );
}
...
fn test_alias_with_special_characters() {
    ...
    cmd.arg("alias")
        ...
        .success()
        .stdout(predicate::str::contains(
            "test-alias_with.special@chars -> session-with-special_chars.too",
        ));
}
